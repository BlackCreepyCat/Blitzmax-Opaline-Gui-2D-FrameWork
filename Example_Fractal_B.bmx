...
Global fractalData:Double[1920, 1080]

Global centerX:Double = 0.0
Global centerY:Double = 0.0
Global zoom:Double = 1.0
Global maxIter:Int = 256

' Julia specific
Global juliaCX:Double = -0.7269
Global juliaCY:Double = 0.1888
...
Global progressPercent:Float = 0.0
...
' ===================
Global winControls:TWindow = New TWindow(20, 20, 380, 780, "Julia Set Explorer", True, True, False, True)
winControls.SetResizable(False)
root.AddChild winControls

Local lblTitle:TLabel = New TLabel(20, 10, 340, 30, "Julia Set Explorer", LABEL_ALIGN_CENTER)
lblTitle.SetColor(220, 180, 255)
...
Global radioClassic:TRadio = New TRadio(20, 15, 20, 20, "Deep Blue", radioPaletteGroup)
radioClassic.selected = True
panelPalette.AddChild radioClassic

Global radioFire:TRadio = New TRadio(20, 50, 20, 20, "Sunset Fire", radioPaletteGroup)
panelPalette.AddChild radioFire

Global radioOcean:TRadio = New TRadio(20, 85, 20, 20, "Ultra Violet", radioPaletteGroup)
panelPalette.AddChild radioOcean

Global radioGray:TRadio = New TRadio(20, 120, 20, 20, "Electric Dreams", radioPaletteGroup)
panelPalette.AddChild radioGray

Global radioCool:TRadio = New TRadio(20, 155, 20, 20, "Cool Mint", radioPaletteGroup)
...
Global lblCenterXValue:TLabel = New TLabel(100, 30, 220, 20, "0.0", LABEL_ALIGN_LEFT)
...
While Not AppTerminate()
    ...
    SetColor 179, 255, 0
    DrawText "Julia Set Explorer - Click to zoom / Drag for rectangle selection", 10, GraphicsHeight() - 40
    ...
    For Local py:Int = 0 Until FRACTAL_HEIGHT
        For Local px:Int = 0 Until FRACTAL_WIDTH
            ...
            While (x*x + y*y <= 4.0) And (iter < maxIter)
                Local xtemp:Double = x*x - y*y + juliaCX
                y = 2*x*y + juliaCY
                x = xtemp
                iter :+ 1
            Wend
...
Function ConvertToImage()
    ...
    For Local py:Int = 0 Until FRACTAL_HEIGHT
        For Local px:Int = 0 Until FRACTAL_WIDTH
            Local mu:Double = fractalData[px, py]
            Local color:Int
